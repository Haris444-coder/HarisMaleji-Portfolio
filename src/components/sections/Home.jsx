    ...
    >
      ...
      <div className="text-center z-10 px-4">
        ...
        <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
          I am a student at Centennial College who
          has experience in C#, Java, Python, C++, Web Development
          (HTML/CSS/JavaScript), SQL and Unix/Linux. I am passionate about
          learning how to code and exploring coding as a whole. As well as to be
          able to build diverse applications.
        </p>
